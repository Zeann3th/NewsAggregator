...
public class BlockchainNewsCrawler extends Crawler {
    ...
    public void crawl() {
        ...
        List<WebElement> articles = driver.findElements(By.cssSelector("#postContainer > div > div > .thumbnail-attachment > a"));
        List<String> articleLinks = new ArrayList<>();
        for (WebElement article : articles) {
            articleLinks.add(article.getAttribute("href"));
        }

        System.out.println("Đang crawl dữ liệu từ Blockchain News...");
        ...
        for (String articleLink : articleLinks) {
            ...
            try {
                ...
                driver.get(driver.findElement(By.cssSelector(".entry-body > div > a")).getAttribute("href"));
                currentAuthor.setName(driver.findElement(By.tagName("h1")).getText());
                currentAuthor.setDescription(driver.findElement(By.cssSelector(".profile-user-desc > div")).getText());
                ...
                currentPost.setThumbnailImage(driver.findElement(By.cssSelector(".main.col-sm-8 > .content-element2 > img")).getAttribute("src"));
                ...
                List<WebElement> articleTags = driver.findElements(By.cssSelector(".tagcloud > a"));
